...
      await userManager.updateProgress(sectionKey, true, 10);
      // Fetch the updated user data to refresh the component
      const updatedUser = await userManager.getCurrentUser();
      setUser(updatedUser);
    }
  };
